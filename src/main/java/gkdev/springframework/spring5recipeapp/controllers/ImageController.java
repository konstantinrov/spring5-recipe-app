...
import gkdev.springframework.spring5recipeapp.services.ImageService;
...
public class ImageController {
    ...
    public void renderImageFromPost(@PathVariable String id, HttpServletResponse response) throws IOException {
