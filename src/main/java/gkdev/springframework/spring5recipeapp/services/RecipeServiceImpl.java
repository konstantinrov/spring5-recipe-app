...
import gkdev.springframework.spring5recipeapp.converters.RecipeCommandToRecipe;
import gkdev.springframework.spring5recipeapp.converters.RecipeToRecipeCommand;
...
public class RecipeServiceImpl implements RecipeService {
    ...
    public Recipe findById(Long id) {
        ...
        if (!recipeOptional.isPresent()) {
            throw new NotFoundExcepiton("Recipe not found. For ID value: " + id.toString());
        }
